...
<html>
<head>
<title>LCA Streaming</title>
<link rel="stylesheet" type="text/css" href="style.css" />
  <script type='text/javascript'>
    function launch_stream(mount) {
        window.open(mount, mount, 'width=682,height=512,location=no,menubar=no,status=no,titlebar=no,toolbar=no' );
    }
  </script>
  <meta http-equiv="refresh" content="30"/>
</head>
<body topmargin="0" leftmargin="0" rightmargin="0" bottommargin="0">
<img src="lca2014.png" style="float: left; width: 100px; padding-right: 1em" />
<h2>LCA 2014 Streaming</h2>
<br />
<!--index header menu -->
<div class="roundcont">
<div class="roundtop">
        ...
        <table cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <td align="right">
                            <a href="javascript:void(0);" onclick="launch_stream('{@mount}');">watch now</a>
...
<tr><td>Framesize:</td><td class="streamdata"> <xsl:value-of select="frame_size" />
 (<xsl:value-of select="frame_rate" /> fps)
</td></tr>
</xsl:if>
<!--
...
<tr><td>Current Listeners:</td><td class="streamdata"> <xsl:value-of select="listeners" />
 (<xsl:value-of select="listener_peak" /> max)
</td></tr>
</xsl:if>
<!--
